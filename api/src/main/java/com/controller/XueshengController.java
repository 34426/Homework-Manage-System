...
public class XueshengController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		request.getSession().setAttribute("role", "xuesheng");
		request.getSession().setAttribute("tableName", "xuesheng");
		request.getSession().setAttribute("username", user.getXuehao());
